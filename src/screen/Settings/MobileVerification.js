...
import { EvilIcons, Entypo, MaterialCommunityIcons,MaterialIcons   } from '@expo/vector-icons';
        ...
        <View style={tailwind`h-full bg-white`}> 
           <Modal visible={modalOpen}>
            ...
            <View style={tailwind`items-center`}>
                <MaterialIcons name="send-to-mobile" size={256} color="#0078B7" />
